    ...
    <Fragment>
      ...
      <div>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to We Are Still Here.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to We Are Still Here, accessible
              from
              <a
                href="https://www.wearestillhere.net"
                target="_blank"
                rel="noreferrer"
              >
                https://www.wearestillhere.net
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            By email:{' '}
            <a href="mailto:privacy@wearestillhere.net">
              privacy@wearestillhere.net
            </a>
          </li>
        </ul>
      </div>
